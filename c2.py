...
def ascii_vro():
 ...
 \___ \| '_ \ / _` | '_ \| __|  / _ \ | |/ _ \| | | |
  ___) | | | | (_| | | | | |_  / ___ \| | (_) | |_| |
 |____/|_| |_|\__, |_| |_|\__|/_/   \_\_|\___/ \__, |
              |___/                              |___/ 
    """)
...
def login():
    ...
    passwd_base64 = "aW5kcmExMgo="

    username = input("⚡ Username: ")
    password = getpass.getpass(prompt='⚡ Password: ')

    # Enkode sandi yang dimasukkan pengguna ke base64
    password_encoded = base64.b64encode(password.encode()).decode()

    if username != user or password_encoded != passwd_base64:
        print("")
        print("⚡ Haizzz, you're so cute...")
        sys.exit(1)
    elif username == user and password_encoded == passwd_base64:
